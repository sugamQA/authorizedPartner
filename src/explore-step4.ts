...
(async () => {
  ...
  if (fileCount > 0) {
    await fileInputs.nth(0).setInputFiles("C:\\Users\\DELL\\Desktop\\test.pdf");
    console.log("  Uploaded test.pdf to first file input");
    await page.waitForTimeout(1000);
  }
  if (fileCount > 1) {
    await fileInputs.nth(1).setInputFiles("C:\\Users\\DELL\\Desktop\\test.pdf");
    console.log("  Uploaded test.pdf to second file input");
    await page.waitForTimeout(1000);
  }

  // Preferred institution types - check checkboxes
